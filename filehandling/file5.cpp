//Read the data from file and display the sum and average of above marks.
//Read the data from file and display the consonant and vowel.
//Read the data from file and display the words and its count.
//Read the data from file and display duplicate character and its count.
#include<iostream>
#include<fstream>
#include<string>
#include<sstream>
