...
int main(){
  ...
  cout<<"Partial Initialised Int Array B : " <<endl;

  for(int y:b)//Shows that for each loop will work according to size of array and not according to the number of elements initialized in the array.

  cout<<y<<endl;

  cout<<endl;

  float c[6]={1.2,2.4,3.6,48.54,999.48,54.88};
  ...
  cout<<"Completely Initialized Float Array D with auto: ";
